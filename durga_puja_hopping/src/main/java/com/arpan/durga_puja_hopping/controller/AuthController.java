...
import com.arpan.durga_puja_hopping.dto.EmailRequest;
import com.arpan.durga_puja_hopping.dto.GenerateOtpResponse;
import com.arpan.durga_puja_hopping.dto.JwtResponse;
...
import com.arpan.durga_puja_hopping.service.impl.EmailServiceImpl;
import com.arpan.durga_puja_hopping.service.impl.OtpServiceImpl;
...
public class AuthController {
	...
	public ResponseEntity<com.arpan.durga_puja_hopping.dto.ApiResponse<String>> dashboard() {
		logger.info("/dashboard encountered >> dashboard()");

		com.arpan.durga_puja_hopping.dto.ApiResponse<String> response = new com.arpan.durga_puja_hopping.dto.ApiResponse<>(200,
	...
	public ResponseEntity<com.arpan.durga_puja_hopping.dto.ApiResponse<JwtResponse>> login(
		...
		if (token == null) {
			com.arpan.durga_puja_hopping.dto.ApiResponse<JwtResponse> response = new com.arpan.durga_puja_hopping.dto.ApiResponse<>(401,
					"Invalid login credentials", null);
			return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(response);
		}

		JwtResponse jwtResponse = new JwtResponse(token, jwtService.extractEmail(token), jwtService.extractRole(token), jwtService.extractName(token));

		com.arpan.durga_puja_hopping.dto.ApiResponse<JwtResponse> response = new com.arpan.durga_puja_hopping.dto.ApiResponse<>(200,
	...
	*/
	...
	@PostMapping("/users")
	public ResponseEntity<com.arpan.durga_puja_hopping.dto.ApiResponse<UserDtls>> register(
			@Valid @RequestBody UserAddRequest userAddRequest) { // Changed return type to UserDtls for simplicity
	...
	@PutMapping("/users")
	public ResponseEntity<com.arpan.durga_puja_hopping.dto.ApiResponse<Void>> updateUserPassword(@RequestBody UserRequest userRequest) {
		...
		if ("User not found".equals(result)) {
			com.arpan.durga_puja_hopping.dto.ApiResponse<Void> response = new com.arpan.durga_puja_hopping.dto.ApiResponse<>(404, "User not found",
					null);
			return ResponseEntity.status(HttpStatus.NOT_FOUND).body(response);
		}

		if ("Invalid or expired OTP".equals(result)) {
			com.arpan.durga_puja_hopping.dto.ApiResponse<Void> response = new com.arpan.durga_puja_hopping.dto.ApiResponse<>(400,
					"Invalid or expired OTP", null);
			return ResponseEntity.badRequest().body(response);
		}

		com.arpan.durga_puja_hopping.dto.ApiResponse<Void> response = new com.arpan.durga_puja_hopping.dto.ApiResponse<>(200,
	...
	@PreAuthorize("hasAnyRole('ADMIN', 'USER')")
	public ResponseEntity<com.arpan.durga_puja_hopping.dto.ApiResponse<Void>> logout(HttpServletRequest request) {
		...
		if (authHeader != null && authHeader.startsWith("Bearer ")) {
			...
			com.arpan.durga_puja_hopping.dto.ApiResponse<Void> response = new com.arpan.durga_puja_hopping.dto.ApiResponse<>(200, "Logout successful",
					null);
			return ResponseEntity.ok(response);
		}
	...
	@PostMapping("/otps")
	public ResponseEntity<com.arpan.durga_puja_hopping.dto.ApiResponse<GenerateOtpResponse>> generateOtp(
		...
		if (resp == null) {
			com.arpan.durga_puja_hopping.dto.ApiResponse<GenerateOtpResponse> response = new com.arpan.durga_puja_hopping.dto.ApiResponse<>(404,
		...
		com.arpan.durga_puja_hopping.dto.ApiResponse<GenerateOtpResponse> response = new com.arpan.durga_puja_hopping.dto.ApiResponse<>(200,
