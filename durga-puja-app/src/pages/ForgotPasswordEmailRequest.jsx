...
const ForgotPasswordEmailRequest = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FDF5E6] p-6">
      <div className="w-full max-w-md bg-linear-to-r from-[#FFCF67]/70 to-[#D3321D]/70 backdrop-blur-md border border-white/20 rounded-2xl shadow-[#8b7777] p-6 shadow-inner">
